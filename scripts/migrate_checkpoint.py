...
def convert_checkpoint(estimator_type, source_checkpoint, target_checkpoint):
...
if __name__ == '__main__':
  ...
  # parser.add_argument('source_graph', type=str, help='Path to source graph file to be read in.')
  parser.add_argument(
      'target_checkpoint',
      type=str,
